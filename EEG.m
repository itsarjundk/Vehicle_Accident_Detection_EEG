...
clear all
close all
header = edfread('ST7011J0-PSG.edf','AssignToVariables',true);
Fs=100;
t=1/Fs;
S =EEGFpzCz;
waveletFunction = 'db8';
...
if POWER_DELTA>POWER_THETA && POWER_DELTA>POWER_ALPHA && POWER_DELTA>POWER_BETA
    disp("The person is Unconscious");
end